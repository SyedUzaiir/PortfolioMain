            ...
            >
              ...
              <div className="pt-4 border-t border-border/40 flex flex-wrap gap-3">
                {selectedProject.github && (
                  ...
                  >
                    <Button variant="primary" className="h-10 px-5 text-xs font-bold uppercase tracking-wider gap-2">
                      <GithubIcon className="h-4 w-4" /> Codebase Repo
                    </Button>
                  </a>
                )}
                {selectedProject.live && (
                  <a
                    ...
                    rel="noopener noreferrer"
                  >
                    <Button variant="secondary" className="h-10 px-5 text-xs font-bold uppercase tracking-wider gap-2">
