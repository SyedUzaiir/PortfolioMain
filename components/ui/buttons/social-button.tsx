...
export const SocialButton: React.FC<SocialButtonProps> = ({
  ...
  return (
    <a
      ...
      className={`inline-flex items-center space-x-2.5 rounded-button border border-border bg-card px-4 py-2.5 text-xs font-bold uppercase tracking-widest text-muted-foreground transition-all hover:text-foreground hover:bg-muted hover:border-foreground/10 cursor-pointer ${className}`}
